...
Розмір файлу трохи збільшився. Також збільшилось `.bss`, адже в ньому тепер міститься створений масив. `.bss` - це частина пам'яті, що використовується для зберігання неініціалізованих глобальних та статичних змінних.
